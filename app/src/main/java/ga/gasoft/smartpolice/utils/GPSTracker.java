...
//      getLocation();
   ...
   * */
   ...
   public void showSettingsAlert(){
      ...
      alertDialog.setMessage(mContext.getResources().getString(R.string.GPSString));
      ...
      alertDialog.setNegativeButton(mContext.getResources().getString(R.string.close), new DialogInterface.OnClickListener() {
         public void onClick(DialogInterface dialog, int which) {
            dialog.cancel();
         }
      });
